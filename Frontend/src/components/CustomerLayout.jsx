            ...
            <aside className={`fixed top-0 left-0 h-screen w-64 bg-surface shadow-xl transform transition-transform duration-300 z-40 ${
                ...
                <div className="p-4 flex flex-col h-full">
                    ...
                    <div className="mt-auto">
                        <Link to="/" className="w-full flex items-center justify-center px-4 py-3 rounded-lg font-medium text-primary bg-blue-100 hover:bg-blue-200 transition-colors">
                            <HomeIcon /> Go to Home
                         </Link>
